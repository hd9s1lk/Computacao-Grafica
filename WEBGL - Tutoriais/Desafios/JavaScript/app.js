...
function PrepareTriangleData(){
    var triangleArray = [
            -0.50, -0.50, 0.0, 1.0, 0.0, 0.0,  //x,y,z,r,g,b
            0.50, -0.50, 0.0, 0.0, 1.0, 0.0,   //definir tamanho do triangulo
...
function loop(){
    ...
    finalMatrix = math.multiply(CriarMatrizEscala(0.25,0.25,0.25),finalMatrix); //multiplicar a finalMatrix por 0.25
    finalMatrix = math.multiply(CriarMatrizEscala(2,2,2),finalMatrix); //multiplicar a finalMatrix por 2
    finalMatrix = math.multiply(CriarMatrizRotacaoZ(angulodeRotacao), finalMatrix); //rodar no eixo do Z
    finalMatrix = math.multiply(CriarMatrizRotacaoX(angulodeRotacao), finalMatrix); //rodar no eixo do X
    finalMatrix = math.multiply(CriarMatrizTranslacao(-0.5,0.5,0), finalMatrix); // triangulo do lado esquerdo
